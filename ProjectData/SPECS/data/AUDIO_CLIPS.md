...
- Aufnahme fordert Browser-seitige Noise-/Echo-Filter (echoCancellation, noiseSuppression, autoGainControl, voiceIsolation, Mono/48 kHz) an; bei Nicht-Unterstützung fällt sie auf Standard `getUserMedia({ audio: true })` zurück.
